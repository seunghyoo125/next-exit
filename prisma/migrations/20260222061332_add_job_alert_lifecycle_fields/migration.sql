...
INSERT INTO "new_JobAlert" ("channel", "company", "createdAt", "decidedAt", "decisionNote", "externalId", "id", "location", "matchedKeywords", "notifiedAt", "postedAt", "status", "title", "url", "userDecision", "watchlistId") SELECT "channel", "company", "createdAt", "decidedAt", "decisionNote", "externalId", "id", "location", "matchedKeywords", "notifiedAt", "postedAt", "status", "title", "url", "userDecision", "watchlistId" FROM "JobAlert";
DROP TABLE "JobAlert";
